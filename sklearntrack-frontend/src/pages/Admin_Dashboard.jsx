...
import { 
  Users, BookOpen, FileText, TrendingUp, Activity, Settings, 
  Bell, Search, Menu, X, ChevronRight, Eye, Edit, Trash2, 
  Download, AlertCircle, CheckCircle, Clock, Award, BarChart3,
  UserPlus, BookPlus, MessageSquare, Shield
} from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-gray-900 to-gray-800 transform transition-transform duration-300 lg:relative lg:translate-x-0 ${
          ...
          <div className="p-6 border-b border-gray-700">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-lg font-bold text-white block">Admin Portal</span>
                  <span className="text-xs text-gray-400">SK-LearnTrack</span>
                </div>
              </div>
                ...
                >
                  ...
                  {item.badge && (
                    <span className={`px-2 py-0.5 text-xs font-bold rounded-full ${
                      item.active ? 'bg-white text-blue-600' : 'bg-gray-700 text-gray-300'
                    }`}>
                      {item.badge}
                    </span>
                  )}
          ...
          <div className="p-4 border-t border-gray-700">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 truncate">admin@sklearntrack.com</p>
              </div>
            </div>
          </div>
        </div>
