    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_level', models.CharField(choices=[('high_school', 'High School'), ('undergraduate', 'Undergraduate'), ('graduate', 'Graduate'), ('postgraduate', 'Postgraduate'), ('professional', 'Professional')], max_length=50)),
